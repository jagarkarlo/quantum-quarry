...
- Verified in the isolated Windows player on 2026-09-24: 188 controlled runtime checks and 20 screenshots covering all 11 scenes, including banking, vent phases/contact damage and armor rounding, pause, invisibility, death/reset, Store round trips, persistent-level transitions, and Pressure HUD bounds at three resolutions. A real-enemy fixture also verifies terrain occlusion, stealth loss/reacquisition, and pressure-scaled perception/pursuit.
